...
public class OpenAPIConfig {
                                        ...
                                        .referenceModel(referenceModelSpecificationBuilder -> referenceModelSpecificationBuilder
                                                .key(modelKeyBuilder -> modelKeyBuilder
                                                        ...
                                                        .qualifiedModelName(qualifiedModelNameBuilder -> qualifiedModelNameBuilder
                                                                .name("ErrorMsg")
                                                                .namespace("com.example.demo.shareddomain.dto")
                                                                .build()
                                                        ).build()
                                                ).build()
                                        ).build()
        ...
        private List<SecurityScheme> securitySchemes() {
                ...
                OAuth oAuth = new OAuthBuilder().name(BEARER_TOKEN_NAME)
                                .grantTypes(Collections.singletonList(grantType)).scopes(Arrays.asList(scopes()))
                                .build();
        ...
        private AuthorizationScope[] scopes() {
                ...
                scopeList.add(new AuthorizationScope("calendar",
